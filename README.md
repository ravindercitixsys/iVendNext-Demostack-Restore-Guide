...
### 4.1. Elavon Payment Processor: V1.0.0 (main)
...
### 4.2. iVendNext: V1.0.0 (Release-1.0)

Already installed — No action required
 
### 4.3. iVend Framework: V1.0.0 (Release-1.0)

Already installed — No action required
 
### 4.4. HW Integration: V1.0.0 (develop)
...
### 4.5. iVend Loyality: V1.0.0 (main)
...
### 4.6. iVendNext POS: V1.0.0 (staging)

 Already installed — No action required
 
### 4.7. iVendNext Reports: V1.0.0 (main)
...
### 4.8. Ivendnext Theme: V1.0.0 (Release-1.0)
...
### 4.9. Moneris Payment Processor: V1.0.0 (main)
...
### 4.10. Payments: V1.0.0 (version-15)

Already installed — No action required
 
### 4.11. Print Designer: V1.0.0 (main)
...
### 5.1. Open the site_config.json file located at:

    /sites/[sitename]/site_config.json
   
### 5.2. Replace the encryption_key value with the one from your backup or configuration source.
